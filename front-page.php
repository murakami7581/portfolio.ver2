   ...
   <div class="p-section__center">
    ...
    <div class="c-section__center--pulse1">
     ...
     <div class="c-section--hexagon--1">
      <div class="c-section--hexagon--1__img"><img src="<?php echo esc_url( get_template_directory_uri() . "/image/html.png" ); ?>"></img></div>
     ...
     <img class="c-section__center__img2" src="<?php echo esc_url( get_template_directory_uri() . "/image/css.png" ); ?>"></img>
     </div>
...
<div class="c-section--hexagon--2__img"><img src="<?php echo esc_url( get_template_directory_uri() . "/image/JQuery.png" ); ?>"></img></div>
  <div class="c-section--hexagon__content">
    <div></div>
    <div></div>
    <div></div>
    ...
    <div class="c-section__center__container">
     <div class="c-section__center--box1">
     <img class="c-section__center__img4" src="<?php echo esc_url( get_template_directory_uri() . "/image/javascript.png" ); ?>"></img>
     <img class="c-section__center__img5" src="<?php echo esc_url( get_template_directory_uri() . "/image/JQuery.png" ); ?>"></img>
     </div>
     <div class="c-section__center--box2">
      <h3 class="c-section__center--text1-1">JavaScript/jQuery</h3>
      <p class="c-section__center--text1-2">実装:ハンバーガーメニュー、アコーディオンメニュー、サイドバー<br>マウスホバー、等の基本的なコード
      </p>
      </div>
      <div class="c-section__center--box3">
      <h3 class="c-section__center--text2">習得度</h3>
...
<div class="c-section--hexagon--3__img"><img src="<?php echo esc_url( get_template_directory_uri() . "/image/javascript.png" ); ?>"></img></div>
  <div class="c-section--hexagon__content">
    <p>
    <div></div>
    <div></div>
...
<div class="c-section--hexagon--4__img"><img src="<?php echo esc_url( get_template_directory_uri() . "/image/sass.png" ); ?>"></img></div>
  <div class="c-section--hexagon__content">
    <div></div>
    <div></div>
    <div></div>
    ...
    <div class="c-section__center__container">
     ...
     <div class="c-section__center--box2">
      <h3 class="c-section__center--text1-1">Sass</h3>
      <p class="c-section__center--text1-2">SCSS記法 設計思想:FLOCSS
      </p>
      </div>
      <div class="c-section__center--box3">
      <h3 class="c-section__center--text2">習得度</h3>
...
<div class="c-section__center__container">
     <div class="c-section__center--box1">
     <img class="c-section__center__img9" src="<?php echo esc_url( get_template_directory_uri() . "/image/wordpress.png" ); ?>"></img>
     </div>
     <div class="c-section__center--box2">
      <h3 class="c-section__center--text1-1">WordPress</h3>
      <p class="c-section__center--text1-2">実装:静的サイトからWordPress化<br>投稿、固定ページ、メニュー作成
      </p>
      </div>
      <div class="c-section__center--box3">
      <h3 class="c-section__center--text2">習得度</h3>
...
<div class="c-section--hexagon--6__img"><img src="<?php echo esc_url( get_template_directory_uri() . "/image/css.png" ); ?>"></img></div>
  <div class="c-section--hexagon__content">
    <div></div>
    <div></div>
    <div></div>
...
<div class="c-section--hexagon--7__img"><img src="<?php echo esc_url( get_template_directory_uri() . "/image/Photoshop.png" ); ?>"></img></div>
  <div class="c-section--hexagon__content">
    <div></div>
    <div></div>
    <div></div>
...
<div class="c-section__center__container">
     <div class="c-section__center--box1">
     <img class="c-section__center__img9" src="<?php echo esc_url( get_template_directory_uri() . "/image/Photoshop.png" ); ?>"></img>
     </div>
     <div class="c-section__center--box2">
      <h3 class="c-section__center--text1-1">Photoshop</h3>
      <p class="c-section__center--text1-2">画像
      </p>
      </div>
      <div class="c-section__center--box3">
      <h3 class="c-section__center--text2">習得度</h3>
...
<div class="c-section--hexagon--8__img"><img src="<?php echo esc_url( get_template_directory_uri() . "/image/Illustrator.png" ); ?>"></img></div>
  <div class="c-section--hexagon__content">
    <div></div>
    <div></div>
    <div></div>
...
<div class="c-section__center__container">
     <div class="c-section__center--box1">
     <img class="c-section__center__img11" src="<?php echo esc_url( get_template_directory_uri() . "/image/Illustrator.png" ); ?>"></img>
    
     </div>
     <div class="c-section__center--box2">
      <h3 class="c-section__center--text1-1">Illustrator</h3>
      <p class="c-section__center--text1-2">画像
      </p>
      </div>
      <div class="c-section__center--box3">
...
<div class="c-section__under--slider">
  ...
  <img src="<?php echo esc_url( get_template_directory_uri() . "/image/computer.png" ); ?>"></img>
  <img src="<?php echo esc_url( get_template_directory_uri() . "/image/gears.png" ); ?>"></img>
  <img src="<?php echo esc_url( get_template_directory_uri() . "/image/cut.jpg" ); ?>"></img>
...
<div class="c-section__under--slider--nav">
<img src="<?php echo esc_url( get_template_directory_uri() . "/image/hamburger.png" ); ?>"></img>
  <img src="<?php echo esc_url( get_template_directory_uri() . "/image/computer.png" ); ?>"></img>
  <img src="<?php echo esc_url( get_template_directory_uri() . "/image/gears.png" ); ?>"></img>
  <img src="<?php echo esc_url( get_template_directory_uri() . "/image/cut.jpg" ); ?>"></img>
